...
"C:\Program Files (x86)\Microsoft SQL Server\100\DTS\Binn\dtexec.exe" /FILE "..\..\WcsSsis\InsertDeviceConfiguration.dtsx" /CONNECTION DeviceConfigurationSpreadsheet;"\"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=..\..\WcsSsis\DeviceConfiguration_Staging_GalwayClinic.xls;Extended Properties=\"\"EXCEL 8.0;HDR=YES\"\"\"" /CONNECTION WCS;"\"Data Source=.;Initial Catalog=WCS;Provider=SQLNCLI10.1;Integrated Security=SSPI;Auto Translate=False;\""  /CHECKPOINTING OFF  /REPORTING E  /X86
if ERRORLEVEL 1 goto :showerror 
